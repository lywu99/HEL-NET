...
_C.MODEL.PRETRAIN_CKPT = './weights/vmamba_tiny_e292.pth'
_C.MODEL.RESUME = ''
...
def add_mamba_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        '--cfg', type=str, default="./weights/yaml/vmamba_tiny.yaml", help='path to config file', )
    parser.add_argument(
        "--opts",
